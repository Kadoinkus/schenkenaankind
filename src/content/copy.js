export const appCopy = {
  brand: "schenkenaankind.nl",
  eyebrow: "Woning schenken aan uw kinderen",
  title:
    "Krijg rustig inzicht in wat u als ouder vanuit uw woning aan uw kinderen kunt meegeven.",
  lead:
    "Deze tool helpt ouders in 2026 om eerst thuis te vergelijken wat het schenken van een deel van de woning aan hun kinderen ongeveer kan betekenen. U ziet eerst de hoofdlijn en opent daarna alleen de uitleg die u nodig hebt.",
  footerNote:
    "Gebaseerd op 2026-uitgangspunten, openbare tarieven en duidelijke uitleg in gewone taal.",
  reviewedOn: "2026-04-15",
};

export const homepageHero = {
  title: "Woning schenken aan uw kinderen",
  body:
    "Bereken hoe u als ouder vanuit uw woning uw kinderen zoveel mogelijk kunt meegeven, met duidelijk inzicht in kosten, belastingen en wat daarbij slim kan zijn.",
  image:
    "https://images.pexels.com/photos/6593916/pexels-photo-6593916.jpeg?auto=compress&cs=tinysrgb&fit=crop&w=1600&h=1200",
  imageAlt:
    "Moeder en dochter samen op de bank als sfeerbeeld voor een rustig familiegesprek.",
  signals: [
    "Wat u uw kinderen kunt meegeven",
    "Kosten en belastingen helder",
    "Rustig thuis bespreken",
  ],
  panelTitle: "Waar u als ouder direct zicht op krijgt",
  panelItems: [
    {
      icon: "chart",
      title: "Besparing in beeld",
      text: "Altijd vergeleken met later erven door uw kinderen.",
    },
    {
      icon: "balance",
      title: "Kosten per onderdeel",
      text: "Met ruimte voor notaris, belastingen en overdracht aan uw kinderen.",
    },
    {
      icon: "family",
      title: "Gezin als vertrekpunt",
      text: "Zodat u eerst thuis begrijpt wat bij uw kinderen past.",
    },
  ],
};
...
export const homepageHighlights = [
  {
    title: "Betrouwbaar vertrekpunt",
    text: "Op basis van uw WOZ 2026, hypotheek en vaste uitgangspunten rond schenken aan kinderen.",
  },
  {
    title: "Rust voor uw gezin",
    text: "Gemaakt om thuis rustig te bekijken wat u uw kinderen kunt meegeven.",
  },
  {
    title: "Besparing zichtbaar",
    text: "Altijd vergeleken met niets doen en later erven door uw kinderen.",
  },
];
...
export const homepageBenefits = [
  {
    icon: "shield",
    title: "Duidelijk wat schenken nu kost",
    text: "Notariskosten, overdrachtsbelasting en andere lasten voor overdracht aan uw kinderen staan niet verstopt in 1 totaalbedrag.",
  },
  {
    icon: "book",
    title: "Duidelijk wat later naar uw kinderen gaat",
    text: "U ziet ook wat wachten tot later kan betekenen voor wat uw kinderen erven, inclusief erfbelasting en nalatenschap.",
  },
  {
    icon: "family",
    title: "Duidelijk thuis te bespreken",
    text: "De uitkomst is zo opgezet dat u er als ouder thuis rustig met uw kinderen naar kunt kijken en over kunt praten.",
  },
];

export const homepageInteractiveTopics = [
  {
    id: "nu",
    label: "Nu schenken",
    icon: "shield",
    eyebrow: "Direct inzicht",
    title: "Zie welke kosten meespelen als u nu aan uw kinderen schenkt",
    text:
      "U ziet welke bedragen kunnen ontstaan als u nu een deel van de woning aan uw kinderen overdraagt.",
    points: [
      "Notariskosten per overdrachtsmoment",
      "Overdrachtsbelasting bij eigendomsoverdracht",
      "Verschil tussen 1 keer schenken en jaarlijkse stappen",
    ],
  },
  {
    id: "later",
    label: "Later nalaten",
    icon: "book",
    eyebrow: "Later overzicht",
    title: "Zie wat later voor uw kinderen kan overblijven",
    text:
      "U ziet wat er voor uw kinderen in de nalatenschap kan blijven als u nu niets doet.",
    points: [
      "Vergelijking met niets doen",
      "Inzicht in het resterende woningdeel",
      "Meer gevoel bij mogelijke erfbelasting later",
    ],
  },
  {
    id: "gezin",
    label: "Samen thuis",
    icon: "family",
    eyebrow: "Samen begrijpelijk",
    title: "Gebouwd om thuis met uw kinderen te bespreken",
    text:
      "De uitleg helpt u als ouder om bedragen en begrippen rustig met uw kinderen door te nemen.",
    points: [
      "Gewone taal naast wat uw kinderen ontvangen",
      "Niet alles hoeft in 1 gesprek duidelijk te zijn",
      "Duidelijk genoeg om thuis samen door te nemen",
    ],
  },
];

export const homepageInteractiveVisual = {
  image:
    "https://images.pexels.com/photos/16266620/pexels-photo-16266620.jpeg?auto=compress&cs=tinysrgb&fit=crop&w=1200&h=900",
  imageAlt:
    "Rijtjeshuizen in een rustige woonstraat als beeld bij het overdragen van een woning binnen de familie.",
  caption:
    "Voor veel ouders begint de afweging bij wat zij hun kinderen vanuit het huis willen meegeven.",
};

export const homepageRuleUpdate = {
  eyebrow: "Van de redactie",
  title: "De jubelton is weg. Dit geldt in 2026.",
  subtitle: "Een korte redactionele uitleg voor ouders die nu willen vergelijken.",
  byline: "Redactie van schenkenaankind.nl",
  dateLabel: "Bijgewerkt april 2026",
  lede:
    "Wie zoekt naar schenken aan kinderen, komt online nog vaak oude bedragen tegen uit de tijd van de jubelton. Voor een vergelijking in 2026 geven die vaak een verkeerd beeld.",
  paragraphs: [
    "Tot en met 2022 kon voor de eigen woning € 106.671 belastingvrij worden geschonken. In 2023 werd dat bedrag verlaagd naar € 28.947. Sinds 1 januari 2024 bestaat deze aparte woningvrijstelling niet meer.",
    "In 2026 is er wel onder voorwaarden een eenmalig verhoogde vrijstelling van € 33.129 van ouder aan kind. Dat is dus een andere regeling dan de oude jubelton.",
    "Daarom rekent deze tool bewust met 2026-bedragen. Zo vergelijkt u niet met oude verhalen, maar met wat nu ongeveer relevant is voor u en uw kinderen.",
  ],
  summaryLabel: "In het kort",
  summaryText:
    "2022: € 106.671. 2023: € 28.947. Vanaf 2024: geen aparte woningvrijstelling meer. 2026: € 33.129 eenmalig verhoogde ouder-kindvrijstelling.",
  ctaLabel: "Start de berekening",
  sourceLabel: "Lees de actuele regels bij de Belastingdienst",
  sourceUrl: "https://www.belastingdienst.nl/wps/wcm/connect/nl/schenken/schenken-en-schenkbelasting",
  image:
    "https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&w=1200&q=80",
  imageAlt:
    "Woonhuis als beeld bij actuele regels rond schenken van de woning aan kinderen.",
};

export const homepageSavingsPoints = [
  {
    title: "Besparen wordt niet alleen geroepen, maar uitgelegd",
    text: "U ziet per route waar verschil ontstaat in wat nu of later bij uw kinderen terechtkomt, zodat u niet op 1 los bedrag hoeft te varen.",
  },
  {
    title: "Moeilijke begrippen blijven op hun plek",
    text: "Toelichtingen openen alleen als u ze nodig hebt, waardoor de pagina rustig blijft voor ouders die snel willen vergelijken.",
  },
  {
    title: "De volgende stap voelt beter voorbereid",
    text: "Wie later verder wil, begint al met een overzicht waarin kosten, eigendom en overdracht aan de kinderen naast elkaar staan.",
  },
];

export const homepagePremiumFeatures = [
  "volledige kostenopbouw per route",
  "uitgebreide tijdlijn met alle bedragen",
  "klikbare uitleg bij de uitkomst",
  "rapport opslaan als PDF voor uw vervolggesprek",
];

export const homepageStorySections = [
  {
    eyebrow: "Gezin voorop",
    title: "Wat u uw kinderen wilt meegeven vraagt om rust en overzicht",
    description:
      "Veel ouders willen hun kinderen helpen zonder later onduidelijkheid of onnodige kosten te veroorzaken. Daarom begint deze tool niet bij ingewikkelde regels, maar bij rustig inzicht.",
    body: [
      "U ziet eerst hoe de belangrijkste routes van elkaar verschillen in wat nu of later naar uw kinderen gaat en waar mogelijke besparing vandaan komt.",
      "Daarna kunt u pas bepalen of u alleen wilt vergelijken, of verder wilt lezen in de volledige uitwerking.",
    ],
    points: [
      {
        icon: "shield",
        title: "Betrouwbaar uitgangspunt",
        text: "Gebaseerd op uw WOZ 2026, hypotheek en de vaste bedragen die in de tool zijn opgenomen.",
      },
      {
        icon: "family",
        title: "Rust in het gesprek thuis",
        text: "De uitkomst helpt om thuis met uw kinderen te begrijpen wat slim kan zijn voordat u verdere stappen zet.",
      },
      {
        icon: "book",
        title: "Heldere taal",
        text: "Begrippen als vrijstelling, overdrachtsbelasting en HRA worden uitgelegd zonder de pagina onrustig te maken.",
      },
    ],
    image:
      "https://images.unsplash.com/photo-1511895426328-dc8714191300?auto=format&fit=crop&w=1600&q=80",
    imageAlt: "Familie samen in een rustige thuissituatie.",
  },
  {
    eyebrow: "Na de eerste vergelijking",
    title: "Eerst zien wat er voor uw kinderen verandert, daarna pas verder beslissen",
    description:
      "De eerste laag van de tool is bedoeld om snel overzicht te geven over wat schenken aan uw kinderen ongeveer betekent. Daarna kunt u zelf bepalen of u verder wilt inzoomen op de volledige opbouw.",
    body: [
      "Zo blijft de landingspagina rustig en voelt de rekentool niet als een muur van uitleg voordat u begonnen bent.",
      "De verdieping is vooral nuttig voor ouders die bedragen later goed willen kunnen plaatsen in een gesprek thuis of met een professional.",
    ],
    points: [
      {
        icon: "chart",
        title: "Verschil per route",
        text: "Zodat u ziet hoe eenmalig schenken, jaarlijks schenken en niets doen zich tot elkaar verhouden.",
      },
      {
        icon: "fileText",
        title: "Kosten helder uitgesplitst",
        text: "Niet alleen een eindbedrag, maar ook de onderdelen die dat bedrag opbouwen.",
      },
      {
        icon: "check",
        title: "Duidelijk genoeg om te bewaren",
        text: "Handig als basis voor uw afweging over wat u uw kinderen wilt meegeven of voor een vervolggesprek.",
      },
    ],
    image:
      "https://images.unsplash.com/photo-1519834785169-98be25ec3f84?auto=format&fit=crop&w=1600&q=80",
    imageAlt: "Ouder en volwassen kind kijken samen naar informatie.",
  },
];

export const homepageTestimonial = {
  eyebrow: "Ervaring van een gezin",
  title: "Eerst thuis inzicht gaf hier veel meer rust",
  intro:
    "Door eerst rustig te vergelijken zagen we dat eerder een deel schenken aan onze kinderen in onze situatie ongeveer € 41.000 kon schelen ten opzichte van niets doen.",
  person: "Marjan, moeder van 2 kinderen",
  context:
    "Zij wilde eerst thuis begrijpen wat zij haar kinderen kon meegeven, voordat zij verder ging praten.",
  savingLabel: "Geschat verschil met niets doen",
  savingValue: "ongeveer € 41.000",
  image:
    "https://images.pexels.com/photos/8055650/pexels-photo-8055650.jpeg?auto=compress&cs=tinysrgb&fit=crop&w=1200&h=900",
  imageAlt: "Moeder en dochter samen op de bank als sfeerbeeld bij een gebruikerservaring.",
  interview: [
    {
      question: "Wat wilde u als moeder eerst weten voor uw kinderen?",
      answer:
        "Vooral of het echt verschil maakte om nu al iets aan onze kinderen over te dragen, of dat wachten tot later in onze situatie ongeveer hetzelfde zou uitpakken.",
    },
    {
      question: "Wat gaf deze vergelijking u thuis als ouder?",
      answer:
        "Rust. We konden thuis naar dezelfde bedragen kijken en zagen duidelijker wat er echt bij onze kinderen terecht zou komen en waar notariskosten, belastingen en het verschil met niets doen vandaan kwamen.",
    },
    {
      question: "Waarom gaf dat vertrouwen?",
      answer:
        "Omdat het niet voelde als een losse rekentool met 1 uitkomst. We konden het stap voor stap volgen en daarna pas bespreken wat logisch voelde.",
    },
  ],
};
...
export const homepageGallery = {
  quote:
    "Een goed besluit voelt rustiger zodra u begrijpt wat er vanuit de woning nu of later naar uw kinderen gaat.",
  attribution: "Voor ouders die eerst thuis duidelijkheid willen.",
  timelineImage: {
    src: "https://images.unsplash.com/photo-1516914943479-89db7d9ae7f2?auto=format&fit=crop&w=1200&q=80",
    alt: "Familie in gesprek aan tafel als sfeerbeeld.",
  },
  images: [
    {
      src: "https://images.unsplash.com/photo-1516302752625-fcc3c50ae61f?auto=format&fit=crop&w=1200&q=80",
      alt: "Familie in gesprek als sfeerbeeld.",
    },
    {
      src: "https://images.unsplash.com/photo-1516589091380-5d601c7f9b4b?auto=format&fit=crop&w=1200&q=80",
      alt: "Ouder en kind samen thuis als sfeerbeeld.",
    },
  ],
};
...
export const homepageSteps = [
  {
    ...
    text: "Gebruik uw WOZ-waarde 2026, hypotheek en een paar eenvoudige aannames als vertrekpunt voor wat u uw kinderen wilt meegeven.",
  },
  {
    icon: "users",
    title: "Vul uw kinderen en gezinssituatie in",
    text: "Vul partner, kinderen en de periode vooruit in, zodat de vergelijking past bij uw gezin.",
  },
  {
    icon: "chart",
    title: "Zie wat dit voor uw kinderen betekent",
    text: "U ziet het verschil tussen niets doen, een eenmalige overdracht en jaarlijkse stappen voor wat uw kinderen ontvangen.",
  },
];
...
export const quickGuidance = [
  {
    ...
    text: "Gebruik de WOZ-waarde, de resterende hypotheek en het aantal kinderen om de vergelijking af te stemmen op wat u uw kinderen wilt meegeven.",
  },
  {
    title: "Lees de routes naast elkaar",
    text: "De vergelijking toont directe lasten in de gekozen periode. In de details ziet u ook terugkerende effecten zoals box 3, overdrachtsbelasting en verlies van hypotheekrenteaftrek bij overdracht aan uw kinderen.",
  },
  {
    title: "Gebruik de uitkomst als gespreksbasis",
    text: "Bij echte overdracht aan uw kinderen spelen ook toestemming van de bank, de akte, de verdeling van de schuld en de woonsituatie van de kinderen mee.",
  },
];
...
export const contextBlocks = [
  {
    ...
    text: "De tool houdt de focus op de woning en op wat u als ouder aan uw kinderen wilt overdragen. Andere bezittingen, schulden en fiscale uitzonderingen blijven buiten beeld.",
  },
  {
